...
/* get_line
	...
	state change - up to max-1 bytes are read from standard input and
	    stored in buff.  Then a nullbyte is appended just after the final
	    character stored, UNLESS end of input before any bytes read.
