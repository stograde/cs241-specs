This document has been sourced from the cs251-specs at https://github.com/StoDevX/cs251-specs

# cs241-specs
This document defines grading information for the CS department at Saint Olaf College. The information allows TA's to grade homework using the automated tool `stograde` specifically for the Hardware Design course (CS 241).
